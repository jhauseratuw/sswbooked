 ...
 */
$conf['settings']['development']['netid'] = 'psych';			// netid for testing

/**
 * Application configuration
 */
$conf['settings']['app.title'] = 'PsyCal';			// application title
...
$conf['settings']['admin.email'] = 'psych@uw.edu';         // email address of admin user
...
$conf['settings']['script.url'] = 'https://depts.washington.edu/psych/department/admin/PsyCal/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['cache.templates'] = $_SERVER['HTTP_HOST'] !== "oldlocal.depts.washington.edu";                  // true recommended, caching template files helps web pages render faster
...
$conf['settings']['registration.notify.admin.email'] = 'wkaplan@uw.edu';		// requires enable.email = true
$conf['settings']['inactivity.timeout'] = '120';     			// minutes before the user is automatically logged out
...
$conf['settings']['reservation']['checkin.minutes.prior'] = '120';
...
$conf['settings']['database']['user'] = 'psycal_admin';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'iov{R;cqNs]49Y9yJE2Cz$oBFC?M8YDK';
$conf['settings']['database']['hostspec'] = 'psych.ovid.u.washington.edu';        // ip, dns or named pipe
$conf['settings']['database']['port'] = 11030;
$conf['settings']['database']['name'] = 'booked_psycal';
/**
 * Mail server configuration
 */
$conf['settings']['phpmailer']['mailer'] = 'smtp';              // options are 'mail', 'smtp' or 'sendmail'
$conf['settings']['phpmailer']['smtp.host'] = 'smtp.gmail.com';               // 'smtp.company.com'
...
$conf['settings']['phpmailer']['smtp.username'] = 'psych@uw.edu';
$conf['settings']['phpmailer']['smtp.password'] = 'b6umK34bn/,Km.dvgN{jkff7j8D.qK';
 ...
 */
$conf['settings']['install.password'] = 'birdie-kerosene-charity-ghoul-stolen-gluiest';
/**
 * Pages
 */
 ...
 * Email
 */
$conf['settings']['email']['default.from.address'] = 'psych@uw.edu';
$conf['settings']['email']['default.from.name'] = 'PsyCal Admin';
/**
 * Reports
 */
