 ...
 */
$conf['settings']['development']['netid'] = '';			// netid for testing

/**
 * Application configuration
 */
$conf['settings']['app.title'] = '';			// application title
...
$conf['settings']['cache.templates'] = $_SERVER['HTTP_HOST'] !== "";                  // true recommended, caching template files helps web pages render faster
...
$conf['settings']['registration.notify.admin.email'] = '';		// requires enable.email = true
...
$conf['settings']['database']['user'] = '';        // database user with permission to the booked database
$conf['settings']['database']['password'] = '';
$conf['settings']['database']['hostspec'] = '';        // ip, dns or named pipe
$conf['settings']['database']['port'] = '';
