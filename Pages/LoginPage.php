...
class LoginPage extends Page implements ILoginPage
{
	...
	public function __construct()
	{
		...
		// TODO: testing showing pending alert
		$netid = $this->GetLoginName();
		$command = new LoginCommand($netid);
		$reader = ServiceLocator::GetDatabase()->Query($command);
		$row = $reader->GetRow();
		$showPendingAlert = $row['status_id'] == 2;
		$this->Set('ShowPendingAlert', $showPendingAlert);
	}
	...
	{
		return $this->GetRawForm(FormKeys::LOGIN_METHOD) ?? 'normal';
	}
