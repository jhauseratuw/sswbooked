...
<div class="page-register">
    ...
    <div id="registration-box" class="default-box col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <form method="post" ajaxAction="{RegisterActions::Register}" id="form-register"
            ...
            <p>Your UW NetID will be used as your username, but you can use another email if you prefer.</p> 
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        {textbox name="PHONE" class="input" value="Phone" required="required" size="20"}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        <label class="reg" for="position">{translate key="Position"}</label>
                        <select {formname key='POSITION'} class="form-control" id="position" required="required" >
                            {html_options values=$PositionValues output=$PositionOutput selected=$Position}
                        </select>
                    </div>
                </div>
            </div>
