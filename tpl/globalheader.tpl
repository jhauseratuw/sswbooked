...
{* TODO: testing styles for netid in nav *}
<style>
    .default-cursor {
        cursor: default;
    }
    .navbar-default .navbar-nav > li > a.default-cursor:hover, .navbar-default .navbar-nav > li > a.default-cursor:focus {
        color: #777;
    }
</style>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="booked-navigation">
                    ...
                    {if $LoggedIn}
                        ...
                        <li class="dropdown" id="navScheduleDropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">{translate key="Schedule"} <b
                                        class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li id="navBookRoom"><a href="/psych/department/admin/PsyCal/Web/landing.php?type=room">Reserve a Room</a></li>
                                <li id="navBookEquipment"><a href="/psych/department/admin/PsyCal/Web/landing.php?type=equipment">Reserve Equipment</a></li>
                        ...
                        {/if}
                        {if ($CanViewAdmin || $CanViewResponsibilities) }
                            <li id="navIntranet"><a href="/psych/department/admin">Intranet Admin</a></li>
                        {/if}
                    {/if}
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    {/if}
                    {if $LoggedIn}
                        <li><a href="#" class="default-cursor">Logged In: {$LoginName}</a></li>
                    {/if}
