...
class LoginPresenter
{
	...
	public function Login()
	{
		...
		if ($this->authentication->Validate($id, $this->_page->GetPassword()))
		{
			...
			$login_method = $this->_page->GetLoginMethod();
			$_SESSION['login_method'] = $login_method;

			$persist = $login_method == 'shibboleth' ? true : $this->_page->GetPersistLogin();
			$context = new WebLoginContext(new LoginData($persist, $this->_page->GetSelectedLanguage()));
