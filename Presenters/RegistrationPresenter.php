...
class RegistrationPresenter extends ActionPresenter
{
	...
	public function PageLoad()
	{
		...
		// Automatically fill the UW email for the user
		$email = $this->page->GetLoginName() . '@uw.edu';
	...
	private function PopulatePositions()
	{
		...
		$positionOutput = array('Select a position...');

		$positions = ['Graduate Student', 'Faculty', 'Post-Doc', 'Staff', 'Other'];
		...
		$this->page->SetPositions($positionValues, $positionOutput);
