...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['CheckingIn'] = 'Checking Out';
		$strings['CheckingOut'] = 'Checking In';
		$strings['CheckIn'] = 'Check Out';
		$strings['CheckOut'] = 'Check In';
		$strings['ReleasedIn'] = 'Released in';
		$strings['CheckedInSuccess'] = 'You are checked out';
		$strings['CheckedOutSuccess'] = 'You are checked in';
		$strings['CheckInFailed'] = 'You could not be checked out';
		$strings['CheckOutFailed'] = 'You could not be checked in';
		$strings['CheckInTime'] = 'Check Out Time';
		$strings['CheckOutTime'] = 'Check In Time';
		...
		$strings['ReservationCannotBeCheckedInTo'] = 'This reservation cannot be checked out.';
		$strings['ReservationCannotBeCheckedOutFrom'] = 'This reservation cannot be checked in.';
		...
		$strings['MissedCheckinEmailSubject'] = 'Missed check out for %s';
		$strings['MissedCheckoutEmailSubject'] = 'Missed check in for %s';
		// End Email Subjects
