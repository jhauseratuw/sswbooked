...
<div id="help">
    ...
    <div id="help-schedules">
        ...
        <p>
            When installing PsyCal a default schedule will be created with out of the box settings. From the
    ...
    <div id="help-resources">
        ...
        <p>Resources in PsyCal can be anything you want to make bookable, such as rooms or equipment. Every
            resource
    ...
    <div id="help-announcements">
        ...
        <p>Announcements are a very simple way to display notifications to PsyCal users.</p>
    ...
    <div id="help-groups">
        ...
        <p>Groups in PsyCal organize users, control resource access permissions and define roles within the
    ...
    <div id="help-users">
        ...
        <p>You can add, view, and manage all registered users from the Users menu item. This tool allows you to change
            ...
            You can also add new users to PsyCal, which is especially useful if self-registration is turned
            off.</p>
    ...
    <div id="help-reporting">
        ...
        <p>Reports are accessible to all application, group, resource and schedule administrators. When the currently
            logged in
            user has access to reporting features, they will see a Reports navigation item. PsyCal comes with
            a set of
    ...
    <div id="help-reminders">
        ...
        <p>Users can request that reminder emails are send prior to the beginning or end of a reservation. In order for
            ...
            /PsyCal/Jobs/sendreminders.php</p>

        <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the full
            path to
            PsyCal/Jobs/sendreminders.php. The full path to sendreminders.php on this server is <span
        ...
        <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled
            ...
            the
            full path to PsyCal\Jobs\sendreminders.php. For example, c:\PHP\php.exe -f
    ...
    <div>
        ...
        <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the full
            path to
            PsyCal/Jobs/autorelease.php. The full path to autorelease.php on this server is <span
        ...
        <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled
            ...
            The task to execute is php followed by
            the
            full path to PsyCal\Jobs\autorelease.php. For example, c:\PHP\php.exe -f
    ...
    <div>
        ...
        <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the full
            path to
            PsyCal/Jobs/sendwaitlist.php. The full path to sendwaitlist.php on this server is <span
        ...
        <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled
            ...
            The task to execute is php followed by
            the
            full path to PsyCal\Jobs\sendwaitlist.php. For example, c:\PHP\php.exe -f
    ...
    <div>
        ...
        <p>On Linux, a cron job can be used. The command to run is <span class="note">php</span> followed by the full
            path to
            PsyCal/Jobs/sendmissedcheckin.php. The full path to sendmissedcheckin.php on this server is <span
        ...
        <p>On Windows, <a href="http://windows.microsoft.com/en-au/windows7/schedule-a-task" target="_blank">a scheduled
            ...
            The task to execute is php followed by
            the
            full path to PsyCal\Jobs\sendmissedcheckin.php. For example, c:\PHP\php.exe -f
    ...
    <div id="help-configuration">
        ...
        <p class="setting"><span>$conf['settings']['default.language']</span>Default language for all users. This can be
            any
            language in the
            PsyCal lang directory</p>

        <p class="setting"><span>$conf['settings']['script.url']</span>The full public URL to the root of this instance
            of
            PsyCal. This should be the Web directory which contains files like schedule.php and calendar.php.
            If this
        ...
        <p class="setting"><span>$conf['settings']['css.extension.file']</span>Full or relative URL to an additional CSS
            ...
            if you
            are not extending the style of PsyCal.</p>
        ...
        <p class="setting"><span>$conf['settings']['uploads']['reservation.attachment.path']</span>The full or relative
            filesystem path (relative to the root of your PsyCal directory) to store reservation attachments.
            This
        ...
        <p class="setting"><span>$conf['settings']['database']['name']</span>Name of PsyCal database</p>
        ...
        <p class="setting"><span>$conf['settings']['api']['enabled']</span>If the PsyCal's RESTful API should
            be enabled.
    ...
    <p class="setting"><span>$conf['settings']['email.suffix']</span>Email suffix to use when storing CAS user account.
        ...
        PsyCal as username@yourdomain.com</p>
