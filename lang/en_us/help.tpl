...
<div id="help">
    ...
    <p>
        Registration is required in order to use PsyCal if you administrator has enabled it. After your
        account
        has been registered
    ...
    <p>Open Google Calendar settings. Click the Calendars tab. Click Browse interesting calendars. Click add by URL.
        Paste
        in the URL printed under the Subscribe to this Calendar link in PsyCal.</p>
