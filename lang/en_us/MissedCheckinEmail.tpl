...
*}
You haven't picked up the equipment from the following PsyCal reservation. Please pick up the item(s) as soon as possible or cancel the reservation.<br/>
Reservation Details:
	<br/>
	<br/>
...
<a href="{$ScriptUrl}">Log in to PsyCal</a>