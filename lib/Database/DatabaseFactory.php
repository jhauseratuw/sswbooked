...
class DatabaseFactory
{
	...
	public static function GetDatabase()
	{
		if (is_null(self::$_instance))
		{
			...
			$port = Configuration::Instance()->GetSectionKey(ConfigSection::DATABASE, ConfigKeys::DATABASE_PORT);

			if (strtolower($databaseType) == 'mysql')
			{
				require_once(ROOT_DIR . 'lib/Database/MySQL/namespace.php');
				self::$_instance = new Database(new MySqlConnection($dbUser, $dbPassword, $hostSpec, $dbName, $port));
			}
			else
			{
