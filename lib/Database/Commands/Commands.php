...
class LoginCommand extends SqlCommand
{
    public function __construct($username)
    {
        ...
        $parameter = new Parameter(ParameterNames::USERNAME, strtolower($username));
...
class GetActivationEmailSent extends SqlCommand
{
    public function __construct($userId)
    {
        parent::__construct(Queries::GET_ACTIVATION_EMAIL_SENT);
        $this->AddParameter(new Parameter(ParameterNames::USER_ID, $userId));
    }
}

class UpdateActivationEmailSent extends SqlCommand
{
    public function __construct($userId, $activationEmailSent)
    {
        parent::__construct(Queries::UPDATE_ACTIVATION_EMAIL_SENT);
        $this->AddParameter(new Parameter(ParameterNames::USER_ID, $userId));
        $this->AddParameter(new Parameter('@activationEmailSent', $activationEmailSent));
    }
}
