...
class MySqlConnection implements IDbConnection
{
     ...
     * @param string $dbName
     */
	public function __construct($dbUser, $dbPassword, $hostSpec, $dbName, $port = 3306)
	{
		$this->_dbUser = $dbUser;
	...
	public function Connect()
	{
		...
		// TODO: testing local environment, requires ssh tunnel as well
		if ($_SERVER['HTTP_HOST'] === "oldlocal.depts.washington.edu") {
			$this->_hostSpec = '127.0.0.1';
		}
